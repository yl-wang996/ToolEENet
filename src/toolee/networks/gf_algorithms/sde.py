# refer to this paper: https://openreview.net/pdf?id=PxTIG12RRHS
# implement the SDEs with different mode
import functools
import os
import sys
...
#----- VE SDE variance exploding stochastic differential equation-----
#------------------
...
#----- sub-VP SDE -----
# a new type of SDEs that is always bounded by the VP SDE at every intermediate time step
#----------------------
